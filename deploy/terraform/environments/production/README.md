...
| <a name="input_userpass_password"></a> [userpass\_password](#input\_userpass\_password) | Password for the ddmlab userpass rucio.cfg (userpass-client.cfg) rendered by module.secrets — used by the ephemeral e2e test container, distinct from bootstrap\_userpass\_pwd's server-side [bootstrap] use. Human-provided, not generated by Terraform. | `string` | n/a | yes |
