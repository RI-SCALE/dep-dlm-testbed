...
BASE_SCHEME_MAP = {
    "srm": ["srm", "gsiftp"],
    "gsiftp": ["srm", "gsiftp"],
    "https": ["https", "http", "davs", "srm+https", "cs3s", "s3s", "root"],
    "davs": ["https", "http", "davs", "srm+https", "cs3s", "s3s"],
    "srm+https": ["https", "davs", "srm+https", "cs3s", "s3s"],
    "cs3s": ["https", "davs", "srm+https", "cs3s", "s3s"],
    "s3s": ["https", "davs", "srm+https", "cs3s", "s3s"],
    "root": ["root", "https"],
    "scp": ["scp"],
    "rsync": ["rsync"],
    "rclone": ["rclone"],
