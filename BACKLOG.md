...
- [ ] Provide runbooks briefly explaining the most important configurations to apply (e.g. Rucio rucio.cfg, OIDC, FTS, RSE settings) so that partners can deploy and operate their own DEP DLM data orchestration workloads.
